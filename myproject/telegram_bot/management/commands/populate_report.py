...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for index, row in enumerate(sheet.iter_rows(min_row=2, values_only=True)):
            ...
            id, id, user_name, phone_number, position, department, oclade_tarif, id, id, id, id, id, id, id, id, id, id, id, id,  compensation_unused_vac, compensation_household_products, lose_feeder_help, lose_feeder_help_Xodjiyev, material_help_retire_injury, prikaz_product, school_items, prochi_nachisleniya, premium_constitution_retire, study, otpusk_ligotniy, premium_constitution, trudovoy_kodeks, premium_9May, premium_Navruz, premium_kurban, premium_independentDay, premium_womenDay_retire, premium_womenDay, compensation_work_stop, hospitalAUP, militar_regist, injury, health_problem_one, oclade_repairment_WTF, oclade_repairment_WWF, oclade_WTF, oclade_WWF, Saturday_work_WTF, Saturday_work_WWF, tariff_WTF, tariff_WWF, Sdelno, hospital_WTF, hospital_WWF, vacation_WTF, vacation_WWF, vacation_add_WTF, vacation_add_WWF, vacation_pregnancy, night_shift_WTF, night_shift_WWF, surcharge, surcharge_ragional_coef, surcharge_acc_ord, clasify, harmfulness, surcharge_advance_pay, loyalty, neyavka, cumulative_surcharge, material_help_cure, material_help, material_help_pansion, material_help_tough_situation, material_help_marriage, pansion, childcare_upto_2, childcare_2_and_3, travel, premium_ramadan, premium_one_time_racism, premium_anniversary, last_month_account, premium_executives, premium_house, day_off, premium_monthly, premium_award_diploma, premium_holiday, labor_agreement, premium_quarters, last_month_account_loyalty, surcharge_harm_repairment_WTF, surcharge_harm_repairment_WWF, vacation_contract, premium_order_advice, afghan_war_people, premium_PMM, repairment, per_day_limit, salary_13month, premium_travel, premium_general, per_day_full_limit, premium_motivation, maternity_leave_WTF, maternity_leave_WWF, material_help_pansion_starting, nutrition_WTF, nutrition_WWF, material_help_death, premium_skvajini, premium_contract, premium_svet, premium_TB, schooler, New_Year, region, material_help_vac, anniversaryx12, salary_13th, salary, income_tax_manual, zarabotnaya_plata, accumulator_fee, car_fee, micro_loan, JO_fee, telephone_fee, militar_regist_fee, yuridik_uslugi, insurance, postal_expenditures, sog_zayav_Rakhimov, Sogspravki_fee, id, id, insurance_life, inventarization_fee, avtouslugi_worker_fee, driver_licence_fee, book_take_fee, tmz_fee, recovery_fee, contract_return, usherb_return_1, usherb_return_2, vozvrat_debitor_fee, return_salary, tax_free_education, vozmesheni_salary, communal_fee,  water_fee,Gosposhlina_fee, dogovor_dostovMizrob, dogovor_5135LGM, dogovor_Buxoro_EKO_TUR, jurnal_order3_fee, tax, vznos_pensiya, vznos_profsoyuz, reluctant_INPS, plastik_karta, kassa, avans, alimony, alimony_postal_gain, uchebnoy_zavedeniya_fee, clasify_fee, viplata_otpusk, viplata_otpusk_dogovor, hostel_fee, vznos_partly, pereraschot, saturday_fee, sanatorium_vouchers_fee, campus_fee, hotel_fee,  fee_general, bank_fee, GSM_fee, phone_monthly_fee, GorGaz_fee, land_owe_fee, nutrition_fee, electricity_fee, loan_credit_consume, loan_credit_OVERDRAFT, loan_credit_fee, loan_credit_ipoteka_no_ligota, loan_credit_ipoteka, study_fee, special_uniform_fee, sanksium_fee_charge_workers, sanksium_general, report_fee, canteen_rent, home_connect_fee, fine, id, id, remain, id, id, *_ = row
