...
class EmployeeReport(BaseModel):
    ...
    Saturday_work_WTF = models.CharField(max_length=100, default="oklad", blank=True, null=True)  #Субботник (001)
    ...
    surcharge_harm_repairment_WTF = models.CharField(max_length=100, default="oklad", blank=True, null=True)    # Надбавка за вредность во время ремонта техники (055)
    ...
    maternity_leave_WTF = models.CharField(max_length=100, default="oklad", blank=True, null=True)  # Декр. больничные (065)
    ...
    nutrition_WTF = models.CharField(max_length=100, default="nutrition", blank=True, null=True)   # Питание (Доплата за питание) (067)
